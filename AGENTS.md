...
apply settings from [naftiko/golden-repo-naftiko — java](https://github.com/naftiko/golden-repo-naftiko/tree/main/java).
...
[`golden-repo-naftiko`](https://github.com/naftiko/golden-repo-naftiko) golden repo
