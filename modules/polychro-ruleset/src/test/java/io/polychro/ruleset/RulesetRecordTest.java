...
class RulesetRecordTest {
    ...
    void rulesetShouldHandleNullExtendsRefs() {
        Ruleset ruleset = new Ruleset(null, Map.of(), List.of(), List.of(), List.of(), Map.of(), null);
        assertEquals(List.of(), ruleset.extendsRefs());
    }

    @Test
    void rulesetShouldHandleNullAliases() {
        Ruleset ruleset = new Ruleset(List.of(), null, List.of(), List.of(), List.of(), Map.of(), null);
        assertEquals(Map.of(), ruleset.aliases());
    }

    @Test
    void rulesetShouldHandleNullOverrides() {
        Ruleset ruleset = new Ruleset(List.of(), Map.of(), null, List.of(), List.of(), Map.of(), null);
    ...
    void rulesetShouldHandleNullFunctions() {
        Ruleset ruleset = new Ruleset(List.of(), Map.of(), List.of(), List.of(), null, Map.of(), null);
        assertEquals(List.of(), ruleset.functions());
    }

    @Test
    void rulesetShouldHandleNullRules() {
        Ruleset ruleset = new Ruleset(List.of(), Map.of(), List.of(), List.of(), List.of(), null, null);
    ...
    void rulesetShouldPreserveNonNullValues() {
        Ruleset ruleset = new Ruleset(
                ...
                List.of(new Function("fn.js", "fn", "")), Map.of("r", new Rule("r", null, null, "warn", true, null, null, List.of(), List.of())),
                "http://docs"
        );
        ...
        assertEquals(List.of("fn"), ruleset.functions().stream().map(Function::functionName).toList());
