...
class RulesetRecordTest {
    ...
    void rulesetShouldHandleNullExtendsRefs() {
        Ruleset ruleset = new Ruleset(null, Map.of(), List.of(), null, List.of(), Map.of(), null);
        assertEquals(List.of(), ruleset.extendsRefs());
    }

    @Test
    void rulesetShouldHandleNullAliases() {
        Ruleset ruleset = new Ruleset(List.of(), null, List.of(), null, List.of(), Map.of(), null);
        assertEquals(Map.of(), ruleset.aliases());
    }

    @Test
    void rulesetShouldHandleNullFormats() {
        Ruleset ruleset = new Ruleset(List.of(), Map.of(), null, null, List.of(), Map.of(), null);
        assertEquals(List.of(), ruleset.formats());
    }

    @Test
    void rulesetShouldHandleNullFunctions() {
        Ruleset ruleset = new Ruleset(List.of(), Map.of(), List.of(), null, null, Map.of(), null);
        assertEquals(List.of(), ruleset.functions());
    }

    @Test
    void rulesetShouldHandleNullRules() {
        Ruleset ruleset = new Ruleset(List.of(), Map.of(), List.of(), null, List.of(), null, null);
    ...
    void rulesetShouldPreserveNonNullValues() {
        Ruleset ruleset = new Ruleset(
                List.of("a"), Map.of("k", "v"), List.of("f"), "./dir",
